  ...
  useEffect(() => {
    const fetchPage = async () => {
      try {
        setLoading(true);
        setError('');
        // Fixed API path: Ensure slash after base URL
        const response = await fetch(`${API_BASE_URL}/page/slug/about-page`);
        ...
        // Fallback default content if API fails or page not found
        const defaultContent = `At Sensokart.com, we specialize in precision measurement and testing solutions for industrial, laboratory, educational, and commercial needs.
...
• Transparency & Trust`;
        ...
        setOriginalContent({ content: defaultContent, metaTitle: '', metaDescription: '' });
        setError(err.message || 'Failed to load content. Using default.');
      } finally {
        setLoading(false);
      }
    };
      ...
      <div className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8 pt-32 pb-16"> {/* Increased pt-24 to pt-32 */}
        ...
        <div className="text-center mb-10">
          ...
          <p className="mt-4 max-w-2xl mx-auto text-xl text-gray-600">
            Learn more about Sensokart.com and our commitment to excellence.
          </p>
        </div>

  ...
  useEffect(() => {
    const fetchPage = async () => {
      try {
        setLoading(true);
        setError('');
        const response = await fetch(`${API_BASE_URL}/page/slug/services`);
      ...
      <div className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8 pt-24 pb-16">
        ...
        <div className="text-center mb-10">
          ...
          <p className="mt-4 max-w-2xl mx-auto text-xl text-gray-600">
            Discover our range of precision measurement and testing solutions.
          </p>
        </div>
                ...
                <div className="space-y-6">
                  <div>
                    ...
                    <textarea
                      ...
                      rows="20"
                      placeholder="Enter the services page content here..."
                    />
                  </div>
                  <div>
